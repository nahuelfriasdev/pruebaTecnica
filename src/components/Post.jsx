        ...
        <div className="flex gap-x-2 w-full">
          ...
          <article className="w-full">
            <div className="flex justify-between items-center">
              ...
              <button className="cursor-pointer hover:bg-blue-400/20 hover:text-blue-500 rounded-full p-1">
                <Ellipsis onClick={() => setOptions(!options)}/>
                {options && (
                  <div className="absolute bg-white shadow-lg rounded-md mt-2">
                    <button className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left" onClick={() => setOptions(false)}>Editar</button>
                    <button 
